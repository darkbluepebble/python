...
obj.add_user("Sean", 93.23, email='hazelblake.98@gmail.com')
obj.add_user("Emilee", 193.23, email='hazelblake.98@gmail.com')
obj.add_user("Marie", 13.23, email='hazelblake.98@gmail.com')
obj.get_details()
obj.send_email()